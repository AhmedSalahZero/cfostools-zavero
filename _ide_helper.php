...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function formatForSelect2($isFunction, $idAttrOrFunction, $titleAttrOrFunction)
        {
                        return \Illuminate\Support\Collection::formatForSelect2($isFunction, $idAttrOrFunction, $titleAttrOrFunction);
        }
