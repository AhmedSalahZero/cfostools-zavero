				...
				<div @if($isRepeater) data-repeater-item @endif class="form-group m-form__group row align-items-center 
					...
					">
				        ...
				        <div class="col-md-12 ">
				            <x-form.select data-modal-type="ManufacturingRevenueStream" :additional-column="'model_type'" :additional-column-value="'ManufacturingRevenueStream'" :add-new-modal="false" :add-new-modal-modal-type="''" :add-new-modal-modal-name="'Category'" :add-new-modal-modal-title="__('Category')" :options="$manufacturingCategories" :add-new="false" :label="__('Category')" class="select2-select category_class  " data-filter-type="{{ $type }}" :all="false" name="category_id" id="{{$type.'_'.'category_id' }}" :selected-value="isset($manufacturingRevenueStream) ? $manufacturingRevenueStream->getCategoryId() : 0"></x-form.select>
					...
					">
				        <x-form.select :additional-column="'model_type'" :additional-column-value="'TradingRevenueStream'" :add-new-modal="false" :add-new-modal-modal-type="''" :add-new-modal-modal-name="'Product'" :add-new-modal-modal-title="__('Product Name')" :previous-select-name-in-dB="'category_id'" :previous-select-must-be-selected="true" :previous-select-selector="'select.category_class'" :previous-select-title="__('Category')" :options="$manufacturingProducts" :add-new="false" :label="__('Product Name')" class="select2-select product_class  " data-filter-type="{{ $type }}" :all="false" name="product_id" id="{{$type.'_'.'product_id' }}" :selected-value="isset($manufacturingRevenueStream) ? $manufacturingRevenueStream->getProductId() : 0"></x-form.select>
				    </div>

				    <div class="col-md-2">
				        <x-form.select :add-new-modal="false" :add-new-modal-modal-type="''" :add-new-modal-modal-name="'SellingUnitOfMeasurement'" :add-new-modal-modal-title="__('Selling Unit Of Measurement')" :options="$sellingUnitOfMeasurements" :add-new="false" :label="__('Selling UOM')" class="select2-select selling_unit_of_measurement_class  " data-filter-type="{{ $type }}" :all="false" name="selling_uom" id="{{$type.'_'.'selling_uom' }}" :selected-value="isset($manufacturingRevenueStream) ? $manufacturingRevenueStream->getSellingUOM() : 0"></x-form.select>
				    </div>

				    <div class="col-md-2">
				        <x-form.select :add-new-modal="false" :add-new-modal-modal-type="''" :add-new-modal-modal-name="'ProductionUnitOfMeasurement'" :add-new-modal-modal-title="__('Production Unit Of Measurement')" :options="$productionUnitOfMeasurements" :add-new="false" :label="__('Production UOM')" class="select2-select production_unit_of_measurement_class  " data-filter-type="{{ $type }}" :all="false" name="production_uom" id="{{$type.'_'.'production_uom' }}" :selected-value="isset($manufacturingRevenueStream) ? $manufacturingRevenueStream->getProductionUOM() : 0"></x-form.select>
