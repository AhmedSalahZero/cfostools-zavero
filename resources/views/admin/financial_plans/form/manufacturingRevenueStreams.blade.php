				...
				@endphp
{{-- {{ dd($manufacturingRevenueStream->getProductionUOM()) }} --}}
{{-- {{ dd($manufacturingRevenueStream->getCategoryId()) }} --}}
				<div @if($isRepeater) data-repeater-item @endif class="form-group m-form__group row align-items-center 
								...
								@endif
								 value="{{ isset($manufacturingRevenueStream) ? $manufacturingRevenueStream->id : 0 }}">
					...
					">
                        ...
                        <div class="col-md-12 ">
                            <x-form.select :add-new-modal="true" :add-new-modal-modal-type="''" :add-new-modal-modal-name="'Category'" :add-new-modal-modal-title="__('Category')" :options="$categories" :add-new="false" :label="__('Category')" class="select2-select category_class  " data-filter-type="{{ $type }}" :all="false" name="category_id" id="{{$type.'_'.'category_id' }}" :selected-value="isset($manufacturingRevenueStream) ? $manufacturingRevenueStream->getCategoryId() : 0"></x-form.select>
					...
					">
				        ...
				        @else --}}
						{{-- {{ dd(isset($manufacturingRevenueStream) ? $manufacturingRevenueStream->getProductId() : 0) }} --}}
				    ...
				    <div class="col-md-1 seat-count-js" >
				        ...
				        <div class="kt-input-icon">
				            <div class="input-group">
								...
								@else 
								name="manfacturing[0][product_to_selling_converter]"
								@endif
								
								 value="{{ isset($manufacturingRevenueStream) ? $manufacturingRevenueStream->getProductToSellingConverter() : 1 }}" step="any">
				            </div>
				        </div>
				    </div>
