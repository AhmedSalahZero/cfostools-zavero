...
<div class="row">
    <div class="col-md-12">
        ...
        <form id="form-id" class="kt-form kt-form--label-right" method="POST" enctype="multipart/form-data" action="{{  isset($disabled) && $disabled ? '#' :  $storeRoute  }}">
            ...
            <input type="hidden" name="ffe_id" value="{{ $ffeId }}">
            ...
            <div class="kt-portlet">
                <div class="kt-portlet__body">
                    ...
                    <div class="table-responsive cost">
                        <table class="table table-striped table-bordered table-hover table-checkable kt_table_2 ">
                            ...
                            <tbody>
                                ...
                                @endphp
                                {{-- {{ dd($financialPlan->getFFEItemForSection($modelName,$currentSectionName , 0)) }} --}}
                                @for($instance = 0 ; $instance<1 ; $instance++) @php $ffeItem=$financialPlan->getFFESItemForSection($model->id ,$modelName,$currentSectionName , $instance);
                                    @endphp
                                    <tr>
                                        @php
                                        $order =1 ;
                                        ...
                                        <td style="vertical-align:middle;text-transform:capitalize;text-align:center">
                                            <input data-has-row-total="0" data-max-row-total="0" data-has-column-total="1" data-max-column-total="0" data-is-percentage="0" data-no-digits="0" data-order="{{ $order }}" data-year="1" data-index="{{ $instance }}" data-id="{{ $instance  }}" type="text" step="0.1" class="item-cost-text mx-auto reculate-contingency-rate form-control only-greater-than-or-equal-zero-allowed target_repeating_amounts" value="{{ $ffeItem ? number_format($ffeItem->getItemCost()):0 }}" style="min-width: 80px;text-align: center" onchange="this.style.width = ((this.value.length + 1) * 10) + 'px';">
                                        ...
                                        <td style="vertical-align:middle;text-transform:capitalize;text-align:center">
                                            ...
                                            <div class="form-group three-dots-parent">
                                                <div class="input-group input-group-sm align-items-center justify-content-center " style="max-width:initial">
                                                    <input onchange="this.style.width = ((this.value.length + 1) * 10) + 'px';" style="min-width: 80px;text-align: center" data-has-row-total="0" data-max-row-total="0" data-has-column-total="1" data-max-column-total="0" data-is-percentage="0" data-no-digits="0" data-order="{{ $order }}" data-year="2" readonly type="text" value="{{ number_format($ffeItem ? $ffeItem->getTotalCost() : 0 ) }}" data-order="{{ $order }}" data-index="{{ $instance }}" onchange="this.style.width = ((this.value.length + 1) * 10) + 'px';" step="0.1" data-id="{{ $instance }}" class="total-cost-text form-control target_repeating_amounts size">
                                    ...
                                    <tr class="total-tr all-visibility-hidden" style="visibility:hidden">
                                        <td style="vertical-align:middle;text-transform:capitalize;text-align:center">
                                            <b>
                                                {{ __('Total') }}
                                            </b>
                    ...
                    <div class="col-12">
                        ...
                        @include('title',['title'=>__('Excution And Payment Term')])
                                ...
                                <div class="col-md-12 mt-3">
                                    <div class="row">
                                        <div class="col-md-3 mt-4">
                                            ...
                                            <div class="kt-input-icon">
                                                <div class="input-group date">
                                                    <input type="text" name="start_date" class="only-month-year-picker date-input form-control recalc-end-date start-date " value="{{ formatDateForInput($model->getStartDate($financialPlan) ?:  ($model->financialPlan ? $model->financialPlan->development_start_date : null))  }} " />
                                        ...
                                        <div class="col-md-3 mt-4">
                                            ...
                                            <div class="kt-input-icon">
                                                <div class="input-group">
                                                    <input type="numeric" name="duration" class="form-control duration recalc-end-date" value="{{ $model->getDuration()?:($financialPlan ? $financialPlan->development_duration : 0) }}" step="1">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3 mt-4">
                                    ...
                                    <div class="col-md-12">
                                        <div class="row installment-section justify-content-between">
                                            ...
                                            <div class="col-md-1  mt-2 d-flex flex-column">
                                                ...
                                                <select name="due_one" class="form-control mr-2 "> @foreach(dueInDays() as $dueDay)
                                                    <option value="{{ $dueDay }}" @if($model->getDueOne()== $dueDay) selected @endif >{{$dueDay }} </option> @endforeach </select>
                                            </div>
                                            <div class="col-md-1  mt-2 ">
                                            ...
                                            <div class="col-md-1  mt-2 d-flex flex-column">
                                                ...
                                                <select name="due_two" class="form-control mr-2 ">
                                            ...
                                            <div class="col-md-2  mt-2 ">
                                                <label class="form-label font-weight-bold">{{ __('Balance Rate Three %') }} </label>
                                                <div class="kt-input-icon">
                                                    <div class="input-group">
                                                        <input readonly type="text" class="form-control only-percentage-allowed balance-rate-three" value="{{   number_format($model->getBalanceRateThree(),1)   }}" step="0.1">
                                                        <input type="hidden" class="balance-rate-three-hidden" name="balance_rate_three" value="{{  $model->getBalanceRateThree()   }}" step="0.1">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-1  mt-2 d-flex flex-column">
                                                <label class="form-label font-weight-bold text-left">{{ __('Due Three') }}</label>
                                                <select name="due_three" class="form-control mr-2 ">
                                                    @foreach(dueInDays() as $dueDay) <option value="{{ $dueDay }}" @if($model->getDueThree()== $dueDay) selected @endif >{{ $dueDay }} </option> @endforeach
                                                </select>
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 mb-4 mt-4">
                                            <label class="form-label font-weight-bold">{{ __('Grant Funding %') }} </label>
                                            <div class="kt-input-icon">
                                                <div class="input-group">
                                                    <input type="text" class="form-control only-percentage-allowed recalculate-debet-funding reclaulate-equity-amount grant-funding grant-funding-input-text" value="{{  number_format($model->getGrantFunding(),1)   }}" step="0.1">
                                                    <input type="hidden" name="grant_funding" class="grant-funding-input-hidden" value="{{  $model->getGrantFunding()   }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-2 mb-4 mt-4">
                                            <label class="form-label font-weight-bold">{{ __('Grant Amount') }} </label>
                                            <div class="kt-input-icon">
                                                <div class="input-group">
                                                    <input readonly type="text" class="form-control grant-amount-input-text" value="{{  number_format($model->getGrantAmount())   }}" step="0.1">
                                                    <input type="hidden" value="{{  $model->getGrantAmount()   }}" class="grant-amount-input-hidden">
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="col-12">
                        ...
                        @include('title',['title'=>__('VAT And Other Expenses')])

                    </div>

                    <div class="col-12">
                        <div class="row vat-and-other-expenses" data-repeater-row=".vat-and-other-expenses">
                            <div class="form-group row" style="flex:1;">
                                <div class="col-md-12 mt-3">
                                    <div class="row">
                                        <div class="col-md-2 mb-4 mt-4">
                                            <label class="form-label font-weight-bold">{{ __('Credit Withhold Tax Rate %') }} </label>
                                            <div class="kt-input-icon">
                                                <div class="input-group">
                                                    <input type="text" class="form-control only-percentage-allowed " value="{{  number_format($model->getCreditWithholdTaxRate(),1)   }}" step="0.1">
                                                    <input type="hidden" name="credit_withhold_tax_rate" class="credit-withhold-tax-rate-hidden" value="{{  $model->getCreditWithholdTaxRate()   }}">
                                                </div>
                                            </div>
                                        </div>

                                        <div class="col-md-2 mb-4 mt-4">
                                            <label class="form-label font-weight-bold">{{ __('Vat Rate %') }} </label>
                                            <div class="kt-input-icon">
                                                <div class="input-group">
                                                    <input type="text" class="form-control only-percentage-allowed " value="{{  number_format($model->getVatRate(),1)   }}" step="0.1">
                                                    <input type="hidden" name="vat_rate" class="vat-rate-hidden" value="{{  $model->getVatRate()   }}">
                                                </div>
                                            </div>
                                        </div>

                                        <div class="col-md-2 mb-4 mt-4">
                                            <label class="form-label font-weight-bold">{{ __('Freight Rate %') }} </label>
                                            <div class="kt-input-icon">
                                                <div class="input-group">
                                                    <input type="text" class="form-control only-percentage-allowed " value="{{  number_format($model->getFreightRate(),1)   }}" step="0.1">
                                                    <input type="hidden" name="freight_rate" class="freight-rate-hidden" value="{{  $model->getFreightRate()   }}">
                                                </div>
                                            </div>
                                        </div>

                                        <div class="col-md-2 mb-4 mt-4">
                                            <label class="form-label font-weight-bold">{{ __('Custom Rate %') }} </label>
                                            <div class="kt-input-icon">
                                                <div class="input-group">
                                                    <input type="text" class="form-control only-percentage-allowed " value="{{  number_format($model->getCustomRate(),1)   }}" step="0.1">
                                                    <input type="hidden" name="custom_rate" class="custom-rate-hidden" value="{{  $model->getCustomRate()   }}">
                                                </div>
                                            </div>
                                        </div>

                                        <div class="col-md-2 mb-4 mt-4">
                                            <label class="form-label font-weight-bold">{{ __('Clearance Rate %') }} </label>
                                            <div class="kt-input-icon">
                                                <div class="input-group">
                                                    <input type="text" class="form-control only-percentage-allowed " value="{{  number_format($model->getClearanceRate(),1)   }}" step="0.1">
                                                    <input type="hidden" name="clearance_rate" class="clearance-rate-hidden" value="{{  $model->getClearanceRate()   }}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2 mb-4 mt-4">
                                            <label class="form-label font-weight-bold">{{ __('Other Expenses Rate %') }} </label>
                                            <div class="kt-input-icon">
                                                <div class="input-group">
                                                    <input type="text" class="form-control only-percentage-allowed " value="{{  number_format($model->getOtherExpensesRate(),1)   }}" step="0.1">
                                                    <input type="hidden" name="other_expenses_rate" class="other-expenses-rate-hidden" value="{{  $model->getOtherExpensesRate()   }}">
                                                </div>
                                            </div>
                                        </div>
...
{{-- {{ dd($nextFFE) }} --}}
<x-save-or-add-new :nextFFE="$nextFFE" :title="__('Save & Go To Next')" :add-new-btn-title="__('Save And Add New Btn')" :add-new-btn-link="route('admin.view.financial.plan.ffe.cost',['company'=>$company->id ,'financial_plan_id'=>$financial_plan_id])" />
</div>
...
<script>
    $(document).on('click', '.save-form', function(e) {
        e.preventDefault(); {
            ...
            let redirectToNextFFE = $(this).attr('data-redirect-to-next-ffe') ? +$(this).attr('data-redirect-to-next-ffe') : 0
            ...
            formData.append('redirect-to-next-FFE', redirectToNextFFE)
...
<script>
    ...
    $(document).on('change', '.recalculate-debet-funding', function(e) {
        ...
        let grantFunding = $('.grant-funding-input-hidden').val();
        grantFunding = number_unformat(grantFunding);

        const debetFunding = (100 - equityFunding - grantFunding);
