...
<div class="row">
    <div class="col-md-12">
        ...
        <form id="form-id" class="kt-form kt-form--label-right" method="POST" enctype="multipart/form-data" action="{{$storeRoute}}">
            ...
            <input type="hidden" name="financial_plan_id" value="{{ $financialPlan->id  }}">
                            ...
                            <div class="col-md-12 mt-3">
                                <div class="row mb-5">
                                    ...
                                    <div class="col-md-2 ">
                                        ...
                                        <div class="kt-input-icon">
                                            <div class="input-group date">
                                              <input type="text" name="purchase_date" class="form-control only-month-year-picker date-input" value="{{ formatDateForInput(isset($model) && $model->getPropertyPurchaseDate()? $model->getPropertyPurchaseDate() : $financialPlan->getStudyStartDate()) }}"  />
                                    ...
                                    <div class="col-md-3 ">
                                        ...
                                        <div class="kt-input-icon">
                                            <div class="input-group">
                                                <input type="text" class="form-control only-greater-than-or-equal-zero-allowed reclaulate-total-purchase-cost purchase-cost" value="{{  number_format($model->getPropertyPurchaseCost(),0)  }}" step="0.1">
                                                <input name="property_purchase_cost" class="" type="hidden" value="{{  $model->getPropertyPurchaseCost()  }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2 ">
                                        ...
                                        <div class="kt-input-icon">
                                            <div class="input-group">
                                                {{-- {{dd($model->getPropertyContingencyRate())}} --}}
                                                <input type="text" class="form-control only-percentage-allowed reclaulate-total-purchase-cost property-contingency-rate" name="property_contingency_rate" value="{{  $model->getPropertyContingencyRate()  }}" step="0.1">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row d-none installment-section" data-property-payment-method="installment">
                                    <div class="col-md-2 mb-5 ">
                                        ...
                                        <div class="kt-input-icon">
                                            <div class="input-group">
                                                <input type="text" class="form-control only-percentage-allowed reclulate-property-balance-sheet " value="{{  number_format($model->getFirstPropertyDownPaymentPercentage(),1)   }}" step="0.1">
                                                <input type="hidden" class="reclulate-property-balance-sheet first-property-down-payment-percentage" name="first_property_down_payment_percentage" value="{{  $model->getFirstPropertyDownPaymentPercentage()   }}" step="0.1">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2 mb-5 ">
                                        ...
                                        <div class="kt-input-icon">
                                            <div class="input-group">
                                                <input type="text" class="form-control only-percentage-allowed reclulate-property-balance-sheet " value="{{   number_format($model->getSecondPropertyDownPaymentPercentage(),1)   }}" step="0.1">
                                                <input type="hidden" class="second-property-down-payment-percentage" name="second_property_down_payment_percentage" value="{{  $model->getSecondPropertyDownPaymentPercentage()   }}" step="0.1">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2 mb-5 ">
                                        ...
                                        <div class="kt-input-icon">
                                            <div class="input-group">
                                                <input type="numeric" class="form-control only-greater-than-or-equal-zero-allowed" name="property_after_month" value="{{  $model->getPropertyAfterMonthDays()   }}" step="1">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2 mb-5 ">
                                        ...
                                        <div class="kt-input-icon">
                                            <div class="input-group">
                                                <input readonly type="text" class="form-control property-balance-rate" value="{{  number_format($model->getPropertyBalanceRate(),1)   }}" step="1">
                                                <input type="hidden" class="form-control property-balance-rate" name="property_balance_rate" value="{{  $model->getPropertyBalanceRate()   }}" step="1">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2 mb-5 ">
                                        ...
                                        <div class="kt-input-icon">
                                            <div class="input-group">
                                                <input name="property_installment_count" type="numeric" class="form-control only-greater-than-or-equal-zero-allowed" value="{{  $model->getPropertyInstallmentCount()   }}" step="1">
                                            </div>
                                        </div>
                                    </div>
                                                                        ...
                                                                        @for($i = 0 ; $i<4 ; $i++) <div class="collection-rate-item mb-3 d-flex flex-column align-items-start col">
                                                                            ...
                                                                            <div class="d-flex">
                                                                                <div class="d-inline-flex align-items-center ">
                                                                                    {{-- {{ dd($model,$model->getSalesChannelRateAndDueInDays($i,'rate')) }} --}}
        ...
        <div class="table-responsive percenatge-from-rooms-revenues-method">
            <table class="table table-striped table-bordered table-hover table-checkable kt_table_2 ">
                ...
                <tbody>
                    ...
                    @for($instance=0 ; $instance<count(getPropertyAcquisitionNameForIndex()) ; $instance++) @php $propertyCostBreakDown=$financialPlan->getPropertyCostBreakdownForSection($modelName,$currentSectionName , $instance);
                        @endphp
                        <tr>
