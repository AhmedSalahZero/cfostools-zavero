...
@endsection
@section('sub-header')
<x-main-form-title :id="'main-form-title'" :class="''">{{ __('Production Unit Of Measurement') }}</x-main-form-title>
@endsection
@section('content')
<div class="row">
    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div @if(!isset($model)) id="m_repeater_2" @endif class="w-100">
                                <div class="form-group  m-form__group row">
                                    <div @if(!isset($model)) data-repeater-list="production_unit_of_measurements" @endif class="col-lg-12">
