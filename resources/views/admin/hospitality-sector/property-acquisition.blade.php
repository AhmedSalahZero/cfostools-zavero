                                    ...
                                    <div class="col-md-2 ">
                                        ...
                                        <div class="kt-input-icon">
                                            <div class="input-group date">
                                              <input type="text" name="purchase_date" class="form-control only-month-year-picker date-input" value="{{ formatDateForInput(isset($model) && $model->getPropertyPurchaseDate()? $model->getPropertyPurchaseDate() : $hospitalitySector->getStudyStartDate()) }}"  />
